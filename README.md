...
* computes your e-index ([https://doi.org/10.1371/journal.pone.0005429](https://doi.org/10.1371/journal.pone.0005429)) and your R-index ([https://doi.org/10.1007/s11434-007-0145-9](https://doi.org/10.1007/s11434-007-0145-9)) provided that your h-index is at most 100 ([reason for limitation later](#respect-google-scholars-robotstxt));
...
used: `[ "total", "fiveYear", "most", "h", "g", "i10", "i100", "i1000", "i10000", "e", "R" ]`. There is no
...
the g-index, e-index, and R-index:

```JSON
{
    "jsonOutputFile": "bibliometrics.json",
    "include": ["total", "fiveYear", "most", "h", "g", "e", "R"],
    "svgConfig": [
        {
            "background": "#010409",
            "border": "rgba(56,139,253,0.4)",
